...
class GraphSearchPolicy(nn.Module):
    ...
    def transit(self, e, obs, kg, use_action_space_bucketing=True, merge_aspace_batching_outcome=False):
        ...
        #TODO: This has to be put outside of the function transit
        ...
        #TODO: Explain the the processess that take place inside this if block
        ...
        #! else block is modified
        else:
            action_space = self.get_action_space(e, obs, kg)
            #* get_action_space is modified, line below is modified
            action_dist, _ = policy_nn_fun(X2)
            db_outcomes = [(action_space, action_dist)]
            inv_offset = None
